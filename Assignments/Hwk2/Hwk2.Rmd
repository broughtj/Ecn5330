...
Change the value of the number of simulations until reject the null hypothesis by values of powers of 10. Start with $1,000$ observations, then $10,000$, etc. How much data do you need to reject the null? 
